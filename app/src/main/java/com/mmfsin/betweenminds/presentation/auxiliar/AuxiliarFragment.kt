...
//                bullseyeVisibility(isVisible = false)
            ...
            countDown(1500) {
                val topText: Int
                if (clue.isBlank()) topText = R.string.ranges_no_clue
                else {
                    topText = R.string.ranges_clue_title
                    tvTopText.showAlpha(1000)
                }

                tvClue.text = getString(topText)
