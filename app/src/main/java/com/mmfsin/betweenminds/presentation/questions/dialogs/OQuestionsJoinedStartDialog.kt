...
import com.mmfsin.betweenminds.databinding.DialogStartQuestionsOnlineJoinedBinding
import dagger.hilt.android.AndroidEntryPoint

@AndroidEntryPoint
class OQuestionsJoinedStartDialog(
    private val close: () -> Unit,
    private val start: () -> Unit,
    private val instructions: () -> Unit,
) : BaseDialog<DialogStartQuestionsOnlineJoinedBinding>() {

    override fun inflateView(inflater: LayoutInflater) =
        DialogStartQuestionsOnlineJoinedBinding.inflate(inflater)
